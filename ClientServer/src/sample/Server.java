...
JPanel mainPanel;
 ...
 static   int setupstage= 0;
  ...
  public Server(){
	...
	status2Panel.add(clientlabel);
	status2Panel.add(clientip);
	...
	mainPanel.add(status2Panel);
	configPanel.setBounds(0,0,400,40);
	statusPanel.setBounds(0,50,400,100);
	status2Panel.setBounds(0,150,400,240);
